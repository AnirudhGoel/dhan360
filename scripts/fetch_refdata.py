...
Sources (all free, no login required):
  ...
  Nifty Smallcap250→ Small Cap (ranks 251-500)
  Nifty Microcap250→ Micro Cap (ranks 501-750)
...
NSE_INDICES = [
    ...
    ("https://archives.nseindia.com/content/indices/ind_niftymicrocap250_list.csv",   "Micro Cap"),
]
...
COMMENT = (
    ...
    "market_cap follows AMFI convention: top-100 = Large Cap, 101-250 = Mid Cap, 251-500 = Small Cap, 501-750 = Micro Cap. "
